...
![Technologies](https://img.shields.io/badge/technologies-Spring_Data_MongoDB%20-green.svg)
...
Set up MongoDB database (see MONGODB_SETUP.md for detailed instructions).
